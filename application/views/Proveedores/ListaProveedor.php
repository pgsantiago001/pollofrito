          ...
          <div class="modal-body">
              <form id="guardando" class="form-horizontal" action="" onsubmit="">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nombre" required>Proveedor:</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="direccion_cont" placeholder="Nombres" name="direccion_cont">
                      </div>
                    </div> 
...
function readRecords() {
    $.get("http://localhost/pollofrito/index.php/Proveedor_controller/tablaProveedor", {}, function (data, status) {
        $("#tabla").html(data);
    });
}
...
function addRecord() {
    // get values
    if($("#nombre").val() == "" || $("#sitioweb").val()== "" || $("#telefono").val()== "" || $("#nit").val()== "" || $("#nombres_cont").val()== "" || $("#apellidos_cont").val()== "" || $("#correoelectronico_cont").val()== "" || $("#telefono_cont").val()== "" || $("#direccion_cont").val()== ""){
    ...
    // agregar registros
    $.post("http://localhost/pollofrito/index.php/Proveedor_controller/nuevoProveedor", {
        idproveedor:               id,
        nombre:                    nombre,
        sitioweb:                  sitioweb,
        telefono:                  telefono,
...
function GetDetails(id) {
    ...
    $("#proveedor_id").val(id);
    $.post("http://localhost/pollofrito/index.php/Proveedor_controller/mostrar_datos_proveedor", {
            id: id
        },
        function (data, status) {
            // PARSE json data
            ...
            $("#nombre").val(proveedor[0].nombre);
            $("#sitioweb").val(proveedor[0].sitioweb);
            $("#telefono").val(proveedor[0].telefono);
            $("#nit").val(proveedor[0].nit);
            $("#nombres_cont").val(proveedor[0].nombres_cont);
            $("#apellidos_cont").val(proveedor[0].apellidos_cont);
            $("#correoelectronico_cont").val(proveedor[0].correoelectronico_cont);
            $("#telefono_cont").val(proveedor[0].telefono_cont);
            $("#direccion_cont").val(proveedor[0].direccion_cont);
        }
    );
}
...
function DeleteRecord(id) {
    ...
    if (conf == true) {
        $.post("http://localhost/pollofrito/index.php/Proveedor_controller/eliminarProveedor", {
                id: id
            },
            function (data, status) {
